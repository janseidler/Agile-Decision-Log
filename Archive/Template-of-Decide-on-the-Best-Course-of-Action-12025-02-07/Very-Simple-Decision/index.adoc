= Decide on "Very Simply Choosing the Best Course of Action" kbd:[name, Titles]
:experimental:
...
source, co-create, decide, resource, adopt, Templates, log, Decisions, Agile, Sustainability, Comprehensibility, Very-Simple-Decision
